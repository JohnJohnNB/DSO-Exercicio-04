...
function Update(){
    ...
    document.getElementById("num_autoclicker").setAttribute("value", farm_count/5)
    document.getElementById("num_farm").setAttribute("value", autoclicker_count)
}

//MÉTODO PARA O DROPDOWN MENU
